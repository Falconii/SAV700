...
public class PedidosGeralActivity extends AppCompatActivity  implements
        LocationListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setSubtitle((rotina.equals("CONSULTA") ? "Pedidos Avulsos" : "Pedidos Composição de Carga"));
        ...
        spCidade =   (Spinner) findViewById(R.id.sp_cidade_334);
        ...
        ordensadapter = new defaultAdapter(PedidosGeralActivity.this, R.layout.choice_default_row, lsOrdens,"");
        ...
        try {
            ...
            Intent intent = new Intent(PedidosGeralActivity.this,AgendamentosAtrasadosActivity.class);
                        ...
                        switch (status.getStatusCode()) {
                            ...
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    status.startResolutionForResult(PedidosGeralActivity.this, HelpInformation.REQUEST_CHECK_SETTINGS);
    ...
    public void onResume() {
        ...
        try {
            ...
            if (POS != null) {
                ...
                Cliente_fast cliente = dao.seek_fast(POS.getCODIGO(), POS.getLOJA(), App.getHoje());
            ...
            Toast.makeText(PedidosGeralActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void LoadClientes(){
        ...
        try {
            ...
            lsLista.addAll(dao.getAll_fast(ordem,""));
            ...
            cidadeadapter = new defaultAdapter(PedidosGeralActivity.this, R.layout.choice_default_row, lsCidades,"Cidade");
            ...
            redeadapter = new defaultAdapter(PedidosGeralActivity.this, R.layout.choice_default_row, lsRedes,"Rede");
            ...
            adapter = new Adapter(PedidosGeralActivity.this, lsLista);
            ...
            Toast.makeText(PedidosGeralActivity.this, "Erro Na Carga: " + e.getMessage(), Toast.LENGTH_LONG).show();
    ...
    public void  onReceiverNotification(NotificationPedido notificationPedido) {
        ...
        try {
            ...
            Cliente_fast cliente = dao.seek_fast(notificationPedido.getCLIENTE(),notificationPedido.getLOJA(),App.getHoje());
        ...
        if (checkPlayServices()) {
            ...
            if (null == mBestReading
                ...
                Executors.newScheduledThreadPool(1).schedule(new Runnable() {
                    ...
                    @Override
                    public void run() {
                        LocationServices.FusedLocationApi.removeLocationUpdates(mGoogleApiClient, PedidosGeralActivity.this);
                    }
                ...
                for (int x = 0; x < lsOriginal.size(); x++) {
                    ...
                    if (lsOriginal.get(x) instanceof Cliente_fast) {
                        ...
                        if (_Ordem.equals("04")) {//fantasia
                            ...
                            if (((Cliente_fast) lsOriginal.get(x)).getFANTASIA().toUpperCase().contains(edPesquisa.getText().toString().trim())) {
                ...
                switch (type) {
                    ...
                    case ITEM_VIEW_DETALHE: {
                        ...
                        if (App.TotvsSIMNAO(obj.getCLIENTEENTREGA()).equals("SIM")){
                            ...
                            lbl_mensagem_400.setTextSize(16f);
    ...
    private class ClickAgenda implements  View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (agenda == null){
                ...
                agenda = new Agendamento("  ",App.getNewIDAgendamento(),obj.getCODIGO(),obj.getLOJA(),App.getHoje(),App.getHoraHHMM(),"",App.user.getCODVEN(),"", "", "", "", "", "", "", "A", "","","",App.getHoje(),App.getHoraHHMM());
                ...
                public void onClick(View v) {
                    ...
                    try {
                        ...
                        if (!NOVO) {
                            ...
                            if (dao.insert(agenda) == null){

                                toast("Falha Na Inclusão Do Agendamento");
                        ...
                        Cliente_fast cliente = daoCliente.seek_fast(obj.getCODIGO(),obj.getLOJA(),App.getHoje());
