...
public final class HelpInformation {
	...
	/*
	 Codigo das Notificações
	 */

	public static final int NotificacaoCargaCompleta  = 100;
	public static final int NotificacaoRefreshPedidos = 101;
	public static final int NotificacaoRefreshPedido  = 102;
	/*
	Configuração
	 */


	public static final String BaseProducao  = "9999";
	public static final String BaseHomolacao = "9877";
	public static final String BaseProtheus  = "9876";

	/*
	Outros
	 */
	public static final int REQUEST_CHECK_SETTINGS  = 700;
